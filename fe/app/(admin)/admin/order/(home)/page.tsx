...
const IndexAdminPage = async ({ searchParams }: { searchParams: Promise<{ type: number | undefined }> }) => {
                                ...
                                return (
                                    <tr>
                                        <td className="pl-3 pb-2 text-center">
                                            <Link className="hover:text-red-400" href={`/admin/order/${v.orderId}` as any}>
                                                {v.orderId}
                                            </Link>
                                        </td>
                                        <td className="pl-3 pb-2 text-center">
                                        ...
                                        <td className="text-center pl-3 pb-2 w-max">{dateFormat(v.orderTime)}</td>
