      ...
      <section className="mt-7.5 pb-17.5 px-3.75">
        <MainCarousel>
          {Array.from({ length: 4 })
            .map((v) => {
              return (
                <div className="basis-10/13 lg:basis-1/4 grow-0 shrink-0 max-lg:pl-3.75 lg:px-3.75 h-max cursor-pointer relative ">
      ...
      <section className="pb-10 lg:pb-17.5 ">
        <MainCarousel >
          {Array.from({ length: 4 })
            .map((v) => {
              return (
                <div className="basis-11/12 grow-0 shrink-0 lg:basis-1/4 px-1.75 ">
                  <Coupon />
                </div>
              )
            })}
      ...
      <section className="pb-17.5">
        <div className="px-3.75" >
          <div style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("categorize_img.jpg")` }}
            className="w-full bg-contain lg:px-5 py-3.75 lg:flex items-center ">
            <div className="px-3.75 w-1/6 max-lg:hidden">
              ...
              <div className="lg:px-3.75  lg:-mx-3.75">
                <MainCarousel >
                  {Array.from({ length: 8 })
                    .map((_) => {
                      return (
                        <div className="max-lg:basis-1/3 basis-33 grow-0 shrink-0">
