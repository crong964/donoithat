                    ...
                    <form>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="pl-7.5 mr-auto text-[14px] leading-5 font-normal">
                                <p>Bạn chưa có tài khoản? <a className="text-[#2962ff]" href="/account">Quên mật khẩu?</a></p>
                                <p>Bạn quên mật khẩu? <a className="text-[#2962ff]" href="/account/register">Đăng ký</a> </p>
                            </div>
                        </div>
                    </form>
                </div>
