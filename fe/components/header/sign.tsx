                            ...
                            <div>
                                <div className="mb-3 relative">
                                    <label className=" h-max" htmlFor="">
                                        ...
                                        <input name="account" type="text" className="text-[12px] h-10.5 pt-3.5 pb-0.75 w-full px-2.5 border border-boder focus:outline-none" />
                                    </label>
                                </div>
                                <div className=" relative">
                                    <label className=" h-max" htmlFor="">
                                        <span className="text-[11px] font-normal absolute top-1 px-2.5">Mật khẩu</span>
                                        <input name="password" type="password" className="text-[12px] h-10.5 pt-3.5 pb-0.75 w-full px-2.5 border border-boder focus:outline-none" />
                                    </label>
                                </div>
                ...
                <div className="absolute animate-cate  z-30 top-full text-text-shop -right-1/7">
                    <div className="min-w-65 border-boder px-5 py-3.75 border shadow-pro rounded-sm bg-white ">
                        <div className="mb-5 pb-2 border-b">
                            <p className="text-f tracking-wide uppercase text-center leading-4.5 text-[15px] font-medium">Thông tin tài khoản</p>
                        </div>
                        <ul>
                            <p className="leading-5.5 -mt-1.25 mb-2 text-[15px] font-medium text-[#282c2d]">{p?.fullName}</p>
                            {
                                action.map((v) => {
                                    return (
