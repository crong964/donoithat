  ...
  return (
    <search className="ml-5 pr-6.25 flex-1">
      ...
      <div className="max-w-170 mx-auto ">
        <div onClick={() => setFocus(true)} className="relative">
          <Form
            action="/search"
            className="bg-white py-0.75 pl-3.75 flex rounded-sm"
          >
            <input
            ...
            <button className="bg-f w-17.5 h-8.75 mx-[2px] rounded-sm">
              <svg
                version="1.1"
                className="w-4.5 fill-white  mx-auto"
                  ...
                  {items.map((v) => {
                    return (
                      <Link
                        ...
                        href={`/product/${v.slug}`}
                        className="hover:text-f py-3 flex"
                      >
                        <div className="flex-1">
                          <p className="leading-3.25 mb-1.25 mt-2.5 text-[13px]">
                            {v.nameProduct}
                          </p>
                          <p className="leading-3.75  text-[12px]">
                            {priceFormat(v.mainPrice + "")}₫
                          </p>
                        </div>
                        <div className="w-10">
                          <img
        ...
        <div className="max-lg:hidden text-[12px] text-white h-5 leading-[17px]">
          <ul className="flex mt-2.5 gap-5">
            <li className="flex items-center gap-1.25">
              <img
                src="/header_03_policy_1_ico.png"
                className="h-5"
                alt=""
                srcSet=""
              />
            ...
            <li className="flex items-center gap-1.25">
              <img
                src="/header_03_policy_2_ico.png"
                className="h-5"
                alt=""
                srcSet=""
              />
            ...
            <li className="flex items-center gap-1.25">
              <img
                src="/header_03_policy_3_ico.png"
                className="h-5"
                alt=""
                srcSet=""
              />
