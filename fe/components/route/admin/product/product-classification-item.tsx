...
export default function ProductClassificationItem(p: {
  ...
  return (
    <div
      ...
      className="mb-4 bg-white p-2 shadow-2xl rounded-sm"
    >
      <div className="flex ">
        ...
        <div className="flex-1">
          <div className="flex flex-wrap">
            {collapse ? (
                ...
                {productClassification.options
                  ...
                  .map((option) => {
                    return (
                      <span
                        key={option.id}
                        className="px-2 rounded-sm shadow-2xl border"
                      >
                        {" "}
                        {option.name}
                      </span>
              ...
              <>
                {productClassification.options.map((option, oi) => {
                  return (
                    <div
                      key={`${productClassification.id} ${option.id}`}
                      className="basis-1/2 p-2.5"
                    >
                      <div className="flex gap-x-3">
                        <Input
                          ...
                          onChange={(v) => {
                            ...
                            if (
                              productClassification.options.length ==
                              oi + 1
                            ) {
                              dispatch(
                                addOptionInProductClassifications({
