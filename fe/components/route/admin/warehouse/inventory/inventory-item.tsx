...
import { SquarePen, Trash2, Truck } from "lucide-react";
  ...
  return (
    <tr ref={dis} data-del={del} className="data-[del=true]:animate-delete ">
      <td className="text-center pb-2 ">
        <span
          data-show={p.onSale}
          className="px-3 rounded-2xl py-1.5 data-[show=false]:bg-red-600 data-[show=true]:bg-green-600 text-white"
        >
