...
export default function AddressRow(v: iAddress) {
  ...
  return (
    <>
      <tr>
        <td className="pb-3 pr-3">{v.title}</td>
        <td className="pb-3 pr-3">{v.address}</td>
        <td className="pb-3 pr-3">
          ...
          <AlertDialog open={open}>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>
                  Bạn có muốn xóa đị chỉ này không?
                </AlertDialogTitle>
                <AlertDialogDescription>
                  Không thể hoàn tác hành động này. Thao tác này sẽ xóa vĩnh
                  viễn tài khoản của bạn và xóa dữ liệu của bạn khỏi máy chủ của
                  chúng tôi.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
