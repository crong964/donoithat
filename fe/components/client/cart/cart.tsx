                ...
                <div className="mt-5  py-2 mb-2.5">
                  <div className="bg-a p-3.75">
                    <div className="mb-2.5 ">
                      <h1 className="text-[14px] leading-5 font-semibold">
                        Ghi chú đơn hàng
                      </h1>
                    </div>
                    <textarea
            ...
            <div className=" shadow-pro mb-3.75 bg-white">
              <div className="p-3.75">
                ...
                <div className="py-2.5 flex items-center mb-2.5 border-y border-boder justify-between">
                  <p className="text-[16px] leading-5.75 font-bold">
                    Tổng tiền:
                  </p>
                  <span className="text-[24px] leading-8.75 font-bold text-f">
                    {PriceFormat(total + "")}₫
                  </span>
                </div>
                <div className="pt-2.25">
                  <ul className="text-[14px] text-[#252a2b] font-normal list-disc pl-3.75">
                    <li className="mb-1 leading-4.75">
                      ...
                      {productVariantCarts.map((v) => {
                        return (
                          <>
                            ...
                            />
                            <input
                              key={v.productVariantId + v.quality}
                              type="hidden"
                              name="quality"
                              value={v.quality}
                            />
