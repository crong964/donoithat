...
export default function WeightProduct() {
  const weightProduct = useSelector(
    (state: RootState) => state.product.weightProduct
  );
    ...
    <div className="mb-4">
      <div className="mb-4">
        <div className="flex space-x-1">
          <h1 className="text-sm font-bold">Khối lượng</h1>
        ...
        <div className="flex items-center gap-x-3">
          <div className="w-max">
            <span className="flex space-x-1">
              <p>Khối lượng</p> <p className="text-red-600">*</p>
            </span>
          </div>
