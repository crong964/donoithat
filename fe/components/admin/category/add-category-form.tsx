...
export default function AddCategoryForm() {
  ...
  return (
    <>
      ...
      <Form
        action={formAction}
        className=" bg-white p-2 rounded-sm shadow-form"
      >
        <section>
          <div className="flex items-center relative">
            ...
            <label htmlFor="image" className="flex-1 size-40 border">
              <div className="flex justify-center items-center h-full">
                ...
                mainCategory.categoryImage == undefined ? (
                  <ImageUp />
                ) : (
                  <img
              ...
              <div className="flex space-x-3">
                ...
                <Button
                  onClick={() => {
                    setMainCategory({
                      ...mainCategory,
                      slug: removeAccents(mainCategory.nameCategory),
                    });
                  }}
                  type="button"
                  variant={"ghost"}
        ...
        <footer className="mt-3.75">
          <ul className="flex justify-between">
            <li>
              ...
              >
                <Button
                  className="bg-a hover:bg-f hover:text-a text-black"
                  type="submit"
                >
                  <p>Thêm</p>
                  <SquarePlus size={15} />
