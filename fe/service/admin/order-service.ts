...
export const getOrderById = async (id: string): Promise<iOrderDetail | undefined> => {
    try {
...
export const updateStatusOrder = async (currentState: any, formData: FormData) => {
    ...
    try {
        ...
        return { time: Date.now(), message: errorResponse(error).message, err: true }
    }
